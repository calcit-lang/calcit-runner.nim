...
proc loadCoreDefs*(programData: var Table[string, ProgramFile], interpret: FnInterpret): void =
  programData[coreNs].defs["&+"] = CirruData(kind: crDataProc, procVal: nativeAdd, procCode: fakeNativeCode("&+"))
  programData[coreNs].defs["&-"] = CirruData(kind: crDataProc, procVal: nativeMinus, procCode: fakeNativeCode("&-"))
  programData[coreNs].defs["&*"] = CirruData(kind: crDataProc, procVal: nativeMultiply, procCode: fakeNativeCode("&*"))
  programData[coreNs].defs["&/"] = CirruData(kind: crDataProc, procVal: nativeDivide, procCode: fakeNativeCode("&/"))
  programData[coreNs].defs["mod"] = CirruData(kind: crDataProc, procVal: nativeMod, procCode: fakeNativeCode("mod"))
  programData[coreNs].defs["&<"] = CirruData(kind: crDataProc, procVal: nativeLessThan, procCode: fakeNativeCode("&<"))
  programData[coreNs].defs["&>"] = CirruData(kind: crDataProc, procVal: nativeGreaterThan, procCode: fakeNativeCode("&>"))
  programData[coreNs].defs["&="] = CirruData(kind: crDataProc, procVal: nativeEqual, procCode: fakeNativeCode("&="))
  programData[coreNs].defs["&and"] = CirruData(kind: crDataProc, procVal: nativeAnd, procCode: fakeNativeCode("&and"))
  programData[coreNs].defs["&or"] = CirruData(kind: crDataProc, procVal: nativeOr, procCode: fakeNativeCode("&or"))
  programData[coreNs].defs["not"] = CirruData(kind: crDataProc, procVal: nativeNot, procCode: fakeNativeCode("not"))
  programData[coreNs].defs["count"] = CirruData(kind: crDataProc, procVal: nativeCount, procCode: fakeNativeCode("count"))
  programData[coreNs].defs["get"] = CirruData(kind: crDataProc, procVal: nativeGet, procCode: fakeNativeCode("get"))
  programData[coreNs].defs["rest"] = CirruData(kind: crDataProc, procVal: nativeRest, procCode: fakeNativeCode("rest"))
  programData[coreNs].defs["raise-at"] = CirruData(kind: crDataProc, procVal: nativeRaiseAt, procCode: fakeNativeCode("raise-at"))
  programData[coreNs].defs["type-of"] = CirruData(kind: crDataProc, procVal: nativeTypeOf, procCode: fakeNativeCode("type-of"))
  programData[coreNs].defs["read-file"] = CirruData(kind: crDataProc, procVal: nativeReadFile, procCode: fakeNativeCode("read-file"))
  programData[coreNs].defs["write-file"] = CirruData(kind: crDataProc, procVal: nativeWriteFile, procCode: fakeNativeCode("write-file"))
  programData[coreNs].defs["parse-json"] = CirruData(kind: crDataProc, procVal: nativeParseJson, procCode: fakeNativeCode("parse-json"))
  programData[coreNs].defs["stringify-json"] = CirruData(kind: crDataProc, procVal: nativeStringifyJson, procCode: fakeNativeCode("stringify-json"))
  programData[coreNs].defs["macroexpand"] = CirruData(kind: crDataProc, procVal: nativeMacroexpand, procCode: fakeNativeCode("macroexpand"))
  programData[coreNs].defs["println"] = CirruData(kind: crDataProc, procVal: nativePrintln, procCode: fakeNativeCode("println"))
  programData[coreNs].defs["echo"] = CirruData(kind: crDataProc, procVal: nativePrintln, procCode: fakeNativeCode("echo"))
  programData[coreNs].defs["pr-str"] = CirruData(kind: crDataProc, procVal: nativePrStr, procCode: fakeNativeCode("pr-str"))
  programData[coreNs].defs["prepend"] = CirruData(kind: crDataProc, procVal: nativePrepend, procCode: fakeNativeCode("prepend"))
  programData[coreNs].defs["append"] = CirruData(kind: crDataProc, procVal: nativeAppend, procCode: fakeNativeCode("append"))
  programData[coreNs].defs["first"] = CirruData(kind: crDataProc, procVal: nativeFirst, procCode: fakeNativeCode("first"))
  programData[coreNs].defs["empty?"] = CirruData(kind: crDataProc, procVal: nativeEmptyQuestion, procCode: fakeNativeCode("empty?"))
  programData[coreNs].defs["last"] = CirruData(kind: crDataProc, procVal: nativeLast, procCode: fakeNativeCode("last"))
  programData[coreNs].defs["butlast"] = CirruData(kind: crDataProc, procVal: nativeButlast, procCode: fakeNativeCode("butlast"))
  programData[coreNs].defs["reverse"] = CirruData(kind: crDataProc, procVal: nativeReverse, procCode: fakeNativeCode("reverse"))
  programData[coreNs].defs["turn-string"] = CirruData(kind: crDataProc, procVal: nativeTurnString, procCode: fakeNativeCode("turn-string"))
  programData[coreNs].defs["turn-symbol"] = CirruData(kind: crDataProc, procVal: nativeTurnSymbol, procCode: fakeNativeCode("turn-symbol"))
  programData[coreNs].defs["turn-keyword"] = CirruData(kind: crDataProc, procVal: nativeTurnKeyword, procCode: fakeNativeCode("turn-keyword"))
  programData[coreNs].defs["identical?"] = CirruData(kind: crDataProc, procVal: nativeIdenticalQuestion, procCode: fakeNativeCode("identical?"))
  programData[coreNs].defs["range"] = CirruData(kind: crDataProc, procVal: nativeRange, procCode: fakeNativeCode("range"))
  programData[coreNs].defs["slice"] = CirruData(kind: crDataProc, procVal: nativeSlice, procCode: fakeNativeCode("slice"))
  programData[coreNs].defs["&concat"] = CirruData(kind: crDataProc, procVal: nativeConcat, procCode: fakeNativeCode("&concat"))
  programData[coreNs].defs["format-ternary-tree"] = CirruData(kind: crDataProc, procVal: nativeFormatTernaryTree, procCode: fakeNativeCode("format-ternary-tree"))
  programData[coreNs].defs["&merge"] = CirruData(kind: crDataProc, procVal: nativeMerge, procCode: fakeNativeCode("&merge"))
  programData[coreNs].defs["contains?"] = CirruData(kind: crDataProc, procVal: nativeContainsQuestion, procCode: fakeNativeCode("contains?"))
  programData[coreNs].defs["assoc-before"] = CirruData(kind: crDataProc, procVal: nativeAssocBefore, procCode: fakeNativeCode("assoc-before"))
  programData[coreNs].defs["assoc-after"] = CirruData(kind: crDataProc, procVal: nativeAssocAfter, procCode: fakeNativeCode("assoc-after"))
  programData[coreNs].defs["keys"] = CirruData(kind: crDataProc, procVal: nativeKeys, procCode: fakeNativeCode("keys"))
  programData[coreNs].defs["assoc"] = CirruData(kind: crDataProc, procVal: nativeAssoc, procCode: fakeNativeCode("assoc"))
  programData[coreNs].defs["dissoc"] = CirruData(kind: crDataProc, procVal: nativeDissoc, procCode: fakeNativeCode("dissoc"))
  programData[coreNs].defs["&str"] = CirruData(kind: crDataProc, procVal: nativeStr, procCode: fakeNativeCode("&str"))
  programData[coreNs].defs["escape"] = CirruData(kind: crDataProc, procVal: nativeEscape, procCode: fakeNativeCode("escape"))
  programData[coreNs].defs["&str-concat"] = CirruData(kind: crDataProc, procVal: nativeStrConcat, procCode: fakeNativeCode("&str-concat"))
  programData[coreNs].defs["parse-cirru-edn"] = CirruData(kind: crDataProc, procVal: nativeParseCirruEdn, procCode: fakeNativeCode("parse-cirru-edn"))
  programData[coreNs].defs["sqrt"] = CirruData(kind: crDataProc, procVal: nativeSqrt, procCode: fakeNativeCode("sqrt"))
  programData[coreNs].defs["ceil"] = CirruData(kind: crDataProc, procVal: nativeCeil, procCode: fakeNativeCode("ceil"))
  programData[coreNs].defs["floor"] = CirruData(kind: crDataProc, procVal: nativeFloor, procCode: fakeNativeCode("floor"))
  programData[coreNs].defs["sin"] = CirruData(kind: crDataProc, procVal: nativeSin, procCode: fakeNativeCode("sin"))
  programData[coreNs].defs["cos"] = CirruData(kind: crDataProc, procVal: nativeCos, procCode: fakeNativeCode("cos"))
  programData[coreNs].defs["round"] = CirruData(kind: crDataProc, procVal: nativeRound, procCode: fakeNativeCode("round"))
  programData[coreNs].defs["pow"] = CirruData(kind: crDataProc, procVal: nativePow, procCode: fakeNativeCode("pow"))
  programData[coreNs].defs["#{}"] = CirruData(kind: crDataProc, procVal: nativeHashSet, procCode: fakeNativeCode("#{}"))
  programData[coreNs].defs["&include"] = CirruData(kind: crDataProc, procVal: nativeInclude, procCode: fakeNativeCode("#include"))
  programData[coreNs].defs["&exclude"] = CirruData(kind: crDataProc, procVal: nativeExclude, procCode: fakeNativeCode("#exclude"))
  programData[coreNs].defs["&difference"] = CirruData(kind: crDataProc, procVal: nativeDifference, procCode: fakeNativeCode("#difference"))
  ...
  programData[coreNs].defs["split"] = CirruData(kind: crDataProc, procVal: nativeSplit, procCode: fakeNativeCode("split"))
  programData[coreNs].defs["split-lines"] = CirruData(kind: crDataProc, procVal: nativeSplitLines, procCode: fakeNativeCode("split-lines"))
