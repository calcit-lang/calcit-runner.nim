...
task watch, "run and watch":
  exec "nim compile --verbosity:0 --hints:off -r src/calcitRunner example/compact.cirru"

task once, "run once":
  exec "nim compile --verbosity:0 --hints:off -r src/calcitRunner --once example/compact.cirru"
