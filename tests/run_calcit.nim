...
# discard runProgram("tests/snapshots/test-macro.cirru")
# discard runProgram("tests/snapshots/test-json.cirru")
discard runProgram("tests/snapshots/test-ternary.cirru")
